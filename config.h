 ...
 */
static char *font = "CaskaydiaCove Nerd Font:pixelsize=16:hinting=true:antialias=true:autohint=false:hintstyle=hintfull:rgba=rgb:lcdfilter=lcdefault:fontformat=CFF";
/* Spare fonts */
static char *font2[] = {
